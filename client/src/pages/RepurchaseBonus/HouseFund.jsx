            ...
            <div className="mx-auto max-w-[1280px]">
                <div className="mb-5 hidden items-start justify-start md:mb-6 md:flex md:justify-end">
                    <div className="min-w-0 text-left md:text-right">
                        ...
                        <p className="mt-2 text-[11px] uppercase tracking-[0.18em] text-[#FB7185]/55">
                ...
                <div className="grid grid-cols-1 gap-3 md:gap-4 lg:grid-cols-[1fr_1fr] lg:gap-5">
                    <div className="overflow-hidden rounded-[2px] border border-[#FB7185]/20 bg-[#171717] shadow-[0_14px_40px_rgba(0,0,0,0.35)]">
                        ...
                        <form className="p-3 text-[12px] text-[#F5E6C8]/75 sm:p-6">
                            ...
                            <button className="mt-4 inline-flex w-full items-center justify-center rounded-[2px] bg-[#FB7185] px-4 py-3 text-[12px] font-black uppercase tracking-[0.12em] text-[#0D0D0D] sm:w-auto">Search &gt;&gt;</button>
                        </form>
                    </div>
                    <div className="flex min-h-[110px] items-center justify-center rounded-[2px] border border-[#FB7185]/35 bg-[linear-gradient(135deg,#3b1621_0%,#fb7185_55%,#fecdd3_100%)] px-4 py-4 text-center shadow-[0_14px_40px_rgba(0,0,0,0.35)] sm:min-h-[160px] sm:px-6 sm:py-8">
                ...
                <div className="mt-4 overflow-hidden rounded-[2px] border border-[#FB7185]/20 bg-[#171717] shadow-[0_14px_40px_rgba(0,0,0,0.35)] md:mt-10">
                    <div className="flex flex-col gap-3 bg-[#271a1f] px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                        <span className="break-words text-[11px] font-black uppercase tracking-[0.18em] text-[#FB7185]">House Fund Report</span>
                        <span className="w-fit rounded-[2px] bg-[#FB7185] px-2 py-1 text-[10px] font-bold text-[#0D0D0D]">0 Records</span>
                    </div>
                    <div className="p-6 text-center text-sm text-[#F5E6C8]/55 sm:p-10">No house fund records available.</div>
                </div>
            </div>
        </div>
    );
