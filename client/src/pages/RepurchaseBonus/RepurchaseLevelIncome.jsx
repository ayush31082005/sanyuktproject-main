    ...
    return (
        <div className="min-h-screen bg-[#0D0D0D] px-3 py-6 text-white md:px-6">
            <div className="mx-auto max-w-[1280px]">
                ...
                <div className="grid grid-cols-1 gap-5 lg:grid-cols-[1fr_1fr]">
                    <div className="overflow-hidden rounded-[2px] border border-[#22C55E]/20 bg-[#171717] shadow-[0_14px_40px_rgba(0,0,0,0.35)]">
                        ...
                        <form onSubmit={handleSearch} className="p-6">
                            ...
                            <button
                                type="submit"
                                className="mt-4 rounded-[2px] bg-[#22C55E] px-4 py-2 text-[12px] font-black uppercase tracking-[0.12em] text-[#0D0D0D] transition hover:bg-[#4ade80]"
                            >
                                Search &gt;&gt;
                            </button>
                        </form>
                    ...
                    <div className="flex min-h-[160px] items-center justify-center rounded-[2px] border border-[#22C55E]/35 bg-[linear-gradient(135deg,#123126_0%,#15803d_45%,#4ade80_100%)] px-6 py-8 text-center shadow-[0_14px_40px_rgba(0,0,0,0.35)]">
                        <div>
                ...
                <div className="mt-10 overflow-hidden rounded-[2px] border border-[#22C55E]/20 bg-[#171717] shadow-[0_14px_40px_rgba(0,0,0,0.35)]">
                    <div className="flex items-center justify-between bg-[#1A2320] px-4 py-3">
                        <span className="text-[11px] font-black uppercase tracking-[0.18em] text-[#22C55E]">
                            Repurchase Level Income Report
                        </span>
                        <span className="rounded-[2px] bg-[#22C55E] px-2 py-1 text-[10px] font-bold text-[#0D0D0D]">
