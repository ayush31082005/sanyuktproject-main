                ...
                <div className="grid grid-cols-1 gap-3 md:gap-4 lg:grid-cols-[1fr_1fr] lg:gap-5">
                    <div className="overflow-hidden rounded-[2px] border border-[#C8A96A]/20 bg-[#171717] shadow-[0_14px_40px_rgba(0,0,0,0.35)]">
                        ...
                        <form onSubmit={handleSearch} className="p-3 sm:p-6">
                            ...
                            <button
                                type="submit"
                                className="mt-4 inline-flex w-full items-center justify-center rounded-[2px] bg-[#C8A96A] px-4 py-3 text-[12px] font-black uppercase tracking-[0.12em] text-[#0D0D0D] transition hover:bg-[#d5b57a] sm:w-auto"
                            >
                                Search &gt;&gt;
                            </button>
                        </form>
                                    ...
                                    {filteredHistory.map((item, index) => (
                                        <div key={item._id} className="rounded-[2px] border border-[#C8A96A]/15 bg-[#111111] p-4">
                                            ...
                                            <div className="space-y-2.5 text-sm text-[#F5E6C8]/90">
                                                ...
                                                <div className="flex items-start justify-between gap-4">
                                                    <span className="text-[#F5E6C8]/55">Bonus</span>
                                                    <span className="text-right font-black text-[#C8A96A]">Rs {formatAmount(item.bonusAmount)}</span>
                                                </div>
                                                <div className="flex items-start justify-between gap-4">
                                                    <span className="text-[#F5E6C8]/55">Description</span>
