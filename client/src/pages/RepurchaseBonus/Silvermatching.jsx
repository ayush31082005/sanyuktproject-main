    ...
    return (
        <div className="min-h-screen overflow-x-hidden bg-[#0D0D0D] px-2 py-4 text-white sm:px-3 sm:py-6 md:px-6">
            <div className="mx-auto max-w-[1280px]">
                ...
                <div className="grid grid-cols-1 gap-3 md:gap-4 lg:grid-cols-[1fr_1fr] lg:gap-5">
                    <div className="overflow-hidden rounded-[2px] border border-[#D7DCE2]/20 bg-[#171717] shadow-[0_14px_40px_rgba(0,0,0,0.35)]">
                        ...
                        <form onSubmit={handleSearch} className="p-3 sm:p-6">
                            <div className="flex flex-col gap-3 text-[12px] text-[#EEF2F6]/75 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
                            ...
                            <button
                                type="submit"
                                className="mt-4 inline-flex w-full items-center justify-center rounded-[2px] bg-[#D7DCE2] px-4 py-3 text-[12px] font-black uppercase tracking-[0.12em] text-[#0D0D0D] transition hover:bg-[#e6ebf0] sm:w-auto"
                            >
                                Search &gt;&gt;
                            </button>
                        </form>
                    ...
                    <div className="flex min-h-[110px] items-center justify-center rounded-[2px] border border-[#D7DCE2]/35 bg-[linear-gradient(135deg,#23272d_0%,#8d97a3_45%,#d7dce2_100%)] px-4 py-4 text-center shadow-[0_14px_40px_rgba(0,0,0,0.35)] sm:min-h-[160px] sm:px-6 sm:py-8">
                        <div>
                ...
                <div className="mt-4 overflow-hidden rounded-[2px] border border-[#D7DCE2]/20 bg-[#171717] shadow-[0_14px_40px_rgba(0,0,0,0.35)] md:mt-10">
                    <div className="flex flex-col gap-3 bg-[#1C2428] px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                        <span className="break-words text-[11px] font-black uppercase tracking-[0.18em] text-[#D7DCE2]">
                            Silver Matching Bonus Report
                        </span>
                        <span className="w-fit rounded-[2px] bg-[#D7DCE2] px-2 py-1 text-[10px] font-bold text-[#0D0D0D]">
                            ...
                            <>
                                <div className="space-y-3 md:hidden">
                                    {filteredHistory.map((item, index) => (
                                        <div key={item._id} className="rounded-[2px] border border-[#D7DCE2]/15 bg-[#111111] p-4">
                                            <div className="mb-3 flex items-start justify-between gap-3">
                                                <div className="min-w-0">
                                                    <div className="text-[10px] font-black uppercase tracking-[0.16em] text-[#D7DCE2]/70">
                                                        Record {index + 1}
                                                    </div>
                                                ...
                                                <div className="shrink-0 rounded-[2px] bg-[#D7DCE2]/12 px-2 py-1 text-[10px] font-black uppercase tracking-[0.12em] text-[#D7DCE2]">
                                                    {item.matchedPV || 0} PV
                                                </div>
                                            </div>

                                            <div className="space-y-2.5 text-sm text-[#EEF2F6]/90">
                                                <div className="flex items-start justify-between gap-4">
                                                    <span className="text-[#EEF2F6]/55">Date</span>
                                                    <span className="text-right font-semibold">{formatDate(item.date)}</span>
                                                </div>
                                                <div className="flex items-start justify-between gap-4">
                                                    <span className="text-[#EEF2F6]/55">Bonus</span>
                                                    <span className="text-right font-black text-[#D7DCE2]">Rs {formatAmount(item.bonusAmount)}</span>
                                                </div>
                                                <div className="flex items-start justify-between gap-4">
                                                    <span className="text-[#EEF2F6]/55">Description</span>
